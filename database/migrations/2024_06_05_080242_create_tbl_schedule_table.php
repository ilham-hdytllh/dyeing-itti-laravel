...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('db_dying')->create('tbl_schedule', function (Blueprint $table) {
            ...
            $table->string('no_mesin', 10)->nullable()->index('tbl_schedule_no_mesin_IDX');
            ...
            $table->string('personil_stdtarget', 50)->nullable();
            $table->dateTime('lastupdatetime_stdtarget')->nullable();
            $table->string('acc_staff', 50)->nullable();
            $table->enum('ket_status', ['Tolak Basah', 'Mini Bulk', 'MC Stop', 'Service MC', 'MC Rusak', 'Test Proses', 'Test Obat', 'Test Mesin', 'Kain Basah', 'Greige', 'Perbaikan', 'Gagal Proses', 'Cuci YD', 'Development Sample', 'Salesmen Sample', 'Cuci Mesin', 'Greige Delay', 'Cuci Misty', 'Scouring-Preset', 'First Lot', 'Relaxing-Preset', 'STOP', 'Ganti Kain Internal', 'Ganti Kain External', 'Cuci Mesin', 'MC Stop', 'MC Dibongkar', ''])->nullable();
            ...
            $table->decimal('target', 4)->nullable();
            $table->integer('revisi')->nullable()->default(0);
            $table->enum('ket_kain', ['Sudah Buka Kain', 'Belum Buka Kain', 'Kain Basah', 'Kain Kering', 'Sudah Jahit Pinggir', 'Pindah Dari Mesin', 'Kain Sudah Preset', 'Ex White', 'Ex Scouring', 'Ex Warna Tua', 'Ex Warna Muda', 'Ex Cuci Mesin', 'Sudah Dokumen', 'Urgent', 'Test Kestabilan', 'STOP', 'MESIN DIBONGKAR'])->nullable();
    ...
    {
        Schema::connection('db_dying')->dropIfExists('tbl_schedule');
    }
};
